...
class myAgent(Agent):
    ...
    def SelectAction(self, actions, gamestate):
        ...
        # startNode = (gamestate, '',0, []) # gamestate, path , huristic
        # visited = set()
        ...
        for action in actions:
            ...
            heuristic_value = getHur(action,agent_state,gamestate)
...
def getHur(action,agent_state,gamestate):
    noble_states = []
    ...
    score_loss = 18 - next_state['score']
    # if score_loss >= 0 :
        # get noble
    noble_loss = 0
    noble_dist = 0
    ...
    # print(score_loss ,noble_loss ,cost_loss, much_same_loss )        
    heuristic_value = 2.5 * score_loss + 0.001 * noble_loss + 0.0001 * cost_loss + 0.5 * much_same_loss 
    # else: 
    #     heuristic_value = 0
